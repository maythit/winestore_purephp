                ...
                <div class="col-sm-3">
                    ...
                    <?php
                        if(isset($_GET['swuid']))
                        {
                            ...
                            $ud = "swineupdate";
                            $wupdate = "swineUpdate";
                            $update_data = mysqli_fetch_array($winecontroller->swineselect($id));
                    ?>
                    ...
                    <?php
                        ...
                        {                            
                    ?>
                            <input type="hidden" name="swuid" value="<?= $id ?>">
                    <?php
                        }
                    ?>
                </div>
...
<!-- datatables for sparkling wine-->
    <div class="container py-2">
        <table id="example" class="display text-center">
            ...
            <tbody>
                <?php                                        
                    $sql = $winecontroller->swineselect("");
                    $i = 1;
                ...
                ?>
                        <tr>
                            ...
                            <td><?= $data['name'] ?></td>
                            <td>
                                <a href="../view/sparklingwine_view.php?swuid=<?= $data['id'] ?>" >Update</a>
                            </td>
                        </tr>
                <?php
                    }
