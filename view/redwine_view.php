...
require_once '../controller/redwine_controller.php';
...
<!-- update link -->
    <div class="container pt-3 align-center">
		<form class="form-group" role="form" action ="../controller/redwine_controller.php" method="post">
                ...
                <div class="col-sm-3">
                    ...
                    <?php
                        if(isset($_GET['id']))
                        {
                            ...
                            $ud = "update";
                            $wupdate = "Update";
                            $update_data = mysqli_fetch_array($redwine->select($id));
                    ?>
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td><?= $data['id'] ?></td>
                            <td>
                                <a href="../view/redwine_view.php?id=<?= $data['id'] ?>" >Update</a>
                            </td>
                        </tr>
                <?php
                    }
