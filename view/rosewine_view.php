		...
		<form class="form-group" role="form" action ="../controller/wine_controller.php" method="post">
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    ...
                    <?php
                        if(isset($_GET['rosewuid']))
                        {
                            $id = $_GET['rosewuid'];
                            $ud = "rosewupdate";
                            $wupdate = "rosewUpdate";
                            $update_data = mysqli_fetch_array($winecontroller->rosewselect($id));
                    ?>
                    ...
                    <?php
                        ...
                        {                            
                    ?>
                            <input type="hidden" name="rosewuid" value="<?= $id ?>">
                    <?php
                        }
                    ?>
                </div>
...
<!-- datatables for rose wine-->
    <div class="container py-2">
        <table id="example" class="display text-center">
            ...
            <tbody>
                <?php                                        
                    $sql = $winecontroller->rosewselect("");
                    $i = 1;
                ...
                ?>
                        <tr>
                            ...
                            <td><?= $data['name'] ?></td>
                            <td>
                                <a href="../view/rosewine_view.php?rosewuid=<?= $data['id'] ?>" >Update</a>
                            </td>
                        </tr>
                <?php
                    }
